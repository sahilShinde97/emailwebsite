...
import { AppContext } from "../../context/AppContext"; // Make sure this import is correct
...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div
      className="min-h-screen flex flex-col items-start justify-between 
    ...
    >
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="flex flex-col flex-center max-w-4xl w-full overflow-hidden 

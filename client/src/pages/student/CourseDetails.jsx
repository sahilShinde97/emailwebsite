...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      ...
      gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 
      pt-20 pb-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p 
          className="pt-4 md:text-base text-sm"dangerouslySetInnerHTML={{
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            ...
            <div className="flex">
              ...
              floor(calculateRating(courseData)) ? assets.star : 
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Vaishnavi Shinde</span>
          </p>
        ...
        >
          ...
          md:pt-4 text-gray-500"
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm mf:text-default list-disc text-gray-500">
